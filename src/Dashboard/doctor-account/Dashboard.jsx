                ...
                {tab ==='overview' && (<div>
                 <div className='flex items-center gap-4 mb-10'>
                  ...
                  <div>
                    ...
                    <span class="bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 text-[12px]
                     leading-4 lg:text-[16px] lg:leading-7 font -semibold rounded ">{data.specialization?data.specialization:'NA'}</span>
                    ...
                    <div className="flex items-center gap-[6px]">
                      ...
                      leading-5 lg:text-[16px] lg:leading-6 font-semibold'> <img src={starIcon} alt="" />{data.averageRating}</span>
